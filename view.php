...
/// Print the page header
 ...
 $strflashcards = get_string('modulenameplural', 'flashcard');
    ...
    //$PAGE->set_headingmenu(navmenu($course, $cm));   //not compatible with 2.8 CRL
    ...
    //$PAGE->navbar->add(get_string('mod_flashcard', 'flashcard'), new moodle_url('/a/link/if/you/want/one.php'));
    //$out = '';
